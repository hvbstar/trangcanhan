...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://t.me/hvb_ip', '_blank');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var audio = new Audio('./audio/Có Anh Ở Đây Rồi - Slex Remix.mp3');
...
welcomeText.textContent = "Welcome To Website Of HOÀNG VĂN BẢO";
...
continueText.textContent = "- Ấn Vào Đây Để Tiếp Tục -";
